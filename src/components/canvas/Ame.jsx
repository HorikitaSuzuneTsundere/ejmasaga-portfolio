...
const Model = React.memo((props) => {
  ...
  Object.values(materials).forEach((material) => {
    material.emissiveIntensity = 0.3; // Decrease the emissive intensity for a darker appearance
    material.color.convertSRGBToLinear(); // Convert the color to linear space for more accurate lighting calculations
  });
